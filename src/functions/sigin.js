...
var firebaseTools_1 = require("../tools/firebaseTools");
var auth = (0, auth_1.getAuth)(firebaseTools_1.firebaseApp);
var token;
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, auth_1.signInWithEmailAndPassword)(auth, email, password)
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!userCredential.user) return [3 /*break*/, 3];
                                    return [4 /*yield*/, userCredential.user];
                                case 1:
                                    user = _a.sent();
