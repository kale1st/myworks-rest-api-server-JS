    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, admin.auth().getUserByEmail(email).then(function (userRecord) { return __awaiter(void 0, void 0, void 0, function () {
...
exports.default = { addUser: addUser, abcd: abcd };
