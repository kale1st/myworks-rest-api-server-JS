...
const bookroutes_1 = __importDefault(
  require("./src/routes/works/Book/bookroutes")
);
// const hatimroutes_1 = __importDefault(require("./src/routes/hatim/hatimroutes"));
const settingsroutes_1 = __importDefault(
  require("./src/routes/settings/settingsroutes")
);
const shbRoutes_1 = __importDefault(
  require("./src/routes/works/Shb/shbRoutes")
);
const pirroutes_1 = __importDefault(
  require("./src/routes/works/pir/pirroutes")
);
const generalroutes_1 = __importDefault(
  require("./src/routes/general/generalroutes")
);
const grouproutes_1 = __importDefault(
  require("./src/routes/group/grouproutes")
);
const pirroutes_2 = __importDefault(
